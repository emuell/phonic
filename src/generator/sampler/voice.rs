...
use crate::{
    ...
    utils::{
        ...
        dsp::modulation::{ModulationMatrix, MAX_MODULATION_BLOCK_SIZE},
        speed_from_note,
    },
...
pub struct SamplerVoice {
    ...
    pub(super) modulation_matrix: ModulationMatrix,
...
impl SamplerVoice {
    pub fn new(file_source: PreloadedFileSource, channel_count: usize, sample_rate: u32) -> Self {
        ...
        Self {
            ...
            grain_pool,
            modulation_matrix,
            modulated_position: [0.0; MAX_MODULATION_BLOCK_SIZE],
            modulated_size: [1.0; MAX_MODULATION_BLOCK_SIZE],
            modulated_density: [1.0; MAX_MODULATION_BLOCK_SIZE],
            sample_rate,
        }
    }
    ...
    pub fn process(
        ...
        let pos_mod = self
            .modulation_matrix
            .get_modulation(super::Sampler::GRAIN_POSITION.id(), 0);
    ...
    fn process_modulation(&mut self, chunk_frames: usize) {
        ...
        self.modulation_matrix.get_modulation_block(
