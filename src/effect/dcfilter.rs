...
impl Effect for DcFilterEffect {
    ...
    fn process_message(&mut self, message: &EffectMessage) {
        if let Some(message) = message.downcast_ref::<DcFilterEffectMessage>() {
            match message {
            ...
            panic!("DcFilterEffect: Received invalid/unknown message '{message:?}'");
        }
    }
    ...
    fn initialize(
        ...
        for _ in 0..channel_count {
            ...
            filter.init(sample_rate, DcFilterMode::default());
