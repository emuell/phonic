...
use super::{formatters, Parameter, ParameterPolarity, ParameterType, ParameterValueUpdate};
...
pub struct IntegerParameter {
    ...
    default: i32,
    unit: &'static str,
    value_to_string: Option<fn(i32) -> String>,
    string_to_value: Option<fn(&str) -> Option<i32>>,
}
...
impl IntegerParameter {
    ...
    pub const fn with_formatter(mut self, formatter: formatters::IntegerFormatter) -> Self {
